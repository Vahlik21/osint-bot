...
TASKS = {
    1: {
        ...
        "difficulty": "⭐⭐ Легкий",
        "key": "GREEN8",
        "photo": r"D:\BOT\images\Таск1.png",
        ...
        "hints": [
            ...
            "🔍 Підказка 2: Зверніть увагу на деталі архітектури",
    ...
    2: {
        ...
        "difficulty": "⭐⭐⭐ Середній",
        "key": "BATA1933",
        "photo": r"D:\BOT\images\Таск2.png",
        "question": "❓ Хто ця людина і в якому році побудована монумент?",
    ...
    3: {
        ...
        "difficulty": "⭐⭐⭐⭐ Складний",
        "photo": r"D:\BOT\images\Таск3.jpg",
        "legend": (
